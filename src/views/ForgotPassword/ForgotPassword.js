...
function ForgotPassword(props) {
	...
	return (
		<>
			<div data-color="black" data-image={require("assets/img/full-screen-image-2.jpg").default} >
								...
								<Card className={"card-login " + cardClasses}>
									...
									<Card.Body>
										...
										<div className="d-flex justify-content-between align-items-center">
											...
											<a href="/admin/login" className="btn-no-bg" type="submit" variant="warning">Login Page</a>
										</div>
									</Card.Body>
