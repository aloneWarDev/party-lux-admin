                                        ...
                                        <Row>
                                            ...
                                            <Col xl={3} sm={6}>
                                                <Form.Group>
                                                    ...
                                                    <DatePicker className="d-block mb-2 " onChange={(e)=>{ handleDate(e , setSearchCreatedAtFrom , 1) } } closeCalendar={isOpenCalenderFrom} value={ searchAtFrom  ? searchAtFrom : null } maxDate ={searchAtTo ? new Date(searchAtTo) :  new Date()} minDate ={minOfSearchAtTo ? new Date(minOfSearchAtTo) : new Date("1800-01-01")}/>
                                            ...
                                            <Col xl={3} sm={6}>
                                                <Form.Group>
                                                    ...
                                                    <DatePicker className="d-block mb-2" onChange={(e)=>{ handleDate(e , setSearchCreatedAtTo , 2) } } closeCalendar={isOpenCalenderAtTo} value={ searchAtTo  ? searchAtTo : null  } maxDate ={new Date()} minDate={searchAtFrom ? new Date(searchAtFrom) : new Date("1800-01-01")} />
                                    ...
                                    <Form className="text-left">
                                        <Form.Group>
                                            <label>Profile Image<span className="text-danger"> *</span></label>
                                                <div className='mb-2'>
                                                    { <img class="img-thumbnail"  src={profileImage ? profileImage : userDefaultImg} onError={(e)=> {e.target.onerror = null ; e.target.src = userDefaultImg}  } style={{width:'100px'}} />} 
                                                </div>
                                                <Form.Control 
...
export default connect(mapStateToProps, { beforeUser, getUsers, deleteUser , createUser , editUser})(Users);